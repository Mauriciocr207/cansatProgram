...
void loop() {  
  ...
  radioAvailable();
  // Enviar datosa
  String frase = "{'primaria':{'a':[213.21312,12.1232,23123.123123],'g':[12323.1232,123123.123123,12321.12323]}}}{'primaria':{'a':[213.21312,12.1232,23123.123123],'g':[12323.1232,123123.123123,12321.12323]}}}\0";
  sendMessage(frase);
  // delay(100);
}
